...
GoDojo AI supports two update channels:
...
# - Tag: v2.0.8-beta.1
# - Title: GoDojo AI v2.0.8-beta.1
# - Mark as "Pre-release"
# - Upload files from release/:
#   - GoDojo AI Setup 2.0.8-beta.1.exe
#   - GoDojo AI.2.0.8-beta.1.exe
...
# 3. Upload to GitHub Release
# - Tag: v2.0.8
# - Title: GoDojo AI v2.0.8
# - Upload files from release/:
#   - GoDojo AI Setup 2.0.8.exe
#   - GoDojo AI.2.0.8.exe
