...
import {
    Plus, Trash2, X, Save, RefreshCw, AlertCircle, CheckCircle2,
    BarChart3, GripVertical, MoreVertical,
    Edit2, Info, RotateCcw, Sparkles, Tag, Weight,
    Search, Monitor, Handshake,
} from 'lucide-react';
import {
    MeetingType,
    SCORECARD_CONFIGS,
    ScoringCriteriaSettings,
    CustomScorecardConfig,
...
const CategoryRow: React.FC<CategoryRowProps> = ({ category, accent, totalCats, isLight, onEdit, onDelete }) => {
