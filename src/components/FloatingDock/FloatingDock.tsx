...
import { Radio, Brain, Hand, EyeOff, Pause, Play, StopCircle, Settings, GripVertical } from 'lucide-react';
...
export const FloatingDock: React.FC<FloatingDockProps> = ({
    ...
    return (
        <motion.div
            ref={constraintsRef}
            className={`relative w-[480px] mx-auto h-fit bg-transparent pointer-events-auto max-w-full rounded-2xl items-center flex flex-col min-h-0 draggable-area ${overlayPanelClass}`}
            style={{ height: activePanel ? '750px' : '150px' }}
        >
            ...
            >
                {/* The Dock */}
                <motion.div
                    className={`flex items-center gap-1 px-3 py-3 rounded-2xl relative select-none`}
                    style={{
