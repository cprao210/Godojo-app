...
import {
    ...
    TrendingUp, Lightbulb, CheckCircle2, AlertCircle, Quote,
} from 'lucide-react';
import {
    MeetingScorecardResult, MeetingScorecard, ScoredCategory,
    MeetingType, SCORECARD_CONFIGS,
...
interface RingProps { score: number; color: string; size?: number; strokeWidth?: number }
...
const CategoryRow: React.FC<CategoryRowProps> = ({ cat, accent, index, isLight }) => {
...
// ─── Main export ──────────────────────────────────────────────────────────────
interface MeetingScorecardPanelProps {
