...
import { NativelyInterfaceMessage, NativelyInterfaceProps } from '@/types';
...
const NativelyInterface: React.FC<NativelyInterfaceProps> = ({ onEndMeeting, overlayOpacity = OVERLAY_OPACITY_DEFAULT }) => {
    ...
    const [messages, setMessages] = useState<NativelyInterfaceMessage[]>([]);
...
Provide only the answer, nothing else.`;
    ...
    const renderMessageText = (msg: NativelyInterfaceMessage) => {
