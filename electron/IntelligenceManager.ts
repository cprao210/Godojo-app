...
export class IntelligenceManager extends EventEmitter {
    ...
    async stopMeeting(meetingTypes?: ('discovery' | 'demo' | 'negotiation')[], tenantId?: string | null, options?: { skipProcessing?: boolean; backendMeetingId?: string | null }): Promise<string | null> {
        return this.persistence.stopMeeting(meetingTypes, tenantId, options);
    }
